...
DEFAULT_MODEL  = "openai/gemma4:e4b"
...
def generate_summary(section_title: str, poi_names: list[str], model: str) -> str:
    """Ask the model for a 2-3 sentence tourism summary of the section."""
    poi_sample = poi_names[:30]  # cap to avoid overly long prompts
    poi_str = ", ".join(poi_sample)
    if len(poi_names) > 30:
...
def main() -> None:
    """Load structure, generate section summaries, save back."""
